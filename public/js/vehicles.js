    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function displayVehicles(data) {
            ...
            data.forEach((item, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger" onclick="confirmDeleteVehicles(${item.id})">Delete</button>
                    </td>
                `;
            ...
            $('#vehiclesTable').DataTable({
                ...
                autowidth: false,
                pageLenght: 10,
                lenghtMenu: [[10, 25, 50, -1], [10, 25, 50, "Semua"]],
                language: {
                    search: "Cari:",
                    lengtMenu: "Tampilkan _MENU _Entri",
                    info: "Menampilkan _START _sampai _END_ dari _TOTAL_ entri",
...
async function confirmDeleteVehicles(id) {
...
async function deleteVehicle(id) {
    try {
        ...
        swal.fire({
            ...
            timer: 3000,
            icon: 'success',
            title: response.data.message || 'Data deleted seccessfully.'
        });
